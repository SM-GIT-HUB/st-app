...
function StartupForm() {
  ...
  async function handleFormSubmit(prevState: any, formData: FormData)
  {
    try {
      ...
      if (err instanceof z.ZodError) {
        const filedErrors = err.flatten().fieldErrors;
      ...
      return {
        ...prevState, error: "An unexpected error as occured", status: "ERROR"
      }
    }
  }
  ...
  <form className='startup-form' action={formAction}>
    ...
    <div data-color-mode="light">
      ...
      <MDEditor value={pitch} id="pitch" preview="edit" height={300} textareaProps={{
        placeholder: "Briefly describe your idea and what problem it solves"
      }}
      previewOptions={{
        disallowedElements: ['style']
      }}
      style={{ borderRadius: 20, overflow: "hidden" }} onChange={(value) => setPitch(value as string)}/>
      {
        errors.pitch &&

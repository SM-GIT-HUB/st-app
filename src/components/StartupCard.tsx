    ...
    <li className="startup-card group">
        ...
        <div className="flex-between mt-5 gap-5">
            ...
            <Link href={`/user/${post.author?._id}`}>
                <Image src={post.image} alt="user img" width={1000} height={1000} className="rounded-full w-[48px] h-[48px]"/>
            </Link>
        </div>
        ...
        <Link href={`/startup/${post._id}`}>
            ...
            <Image src={post.image} alt="img" width={500} height={500} className="startup-card_img" />
        </Link>
